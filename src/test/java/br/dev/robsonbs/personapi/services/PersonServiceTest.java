package br.dev.robsonbs.personapi.services;
...
import static br.dev.robsonbs.personapi.utils.PersonUtils.createFakeDTO;
import static br.dev.robsonbs.personapi.utils.PersonUtils.createFakeEntity;
...
public class PersonServiceTest {
  ...
  void testGivenPersonDTOThenReturnSuccessSavedMessage() {
    ...
    assertEquals("Person successfully created with ID 1",
            successMessage.getMessage());
  }
  
  @Test
  void testGivenValidPersonIdThenReturnThisPerson() throws
  ...
  @Test
  void testGivenValidPersonIdAndUpdateInfoThenReturnSuccesOnUpdate() throws
          PersonNotFoundException {
    ...
    when(personMapper.toModel(updatePersonDTORequest))
            .thenReturn(expectedPersonUpdated);
    when(personRepository.save(any(Person.class)))
            .thenReturn(expectedPersonUpdated);
    
    MessageResponseDTO successMessage = personService.update(updatedPersonId,
            updatePersonDTORequest);
    
    assertEquals("Person successfully updated with ID 2",
            successMessage.getMessage());
  }
  
  @Test
  void testGivenInvalidPersonIdAndUpdateInfoThenThrowExceptionOnUpdate() throws
          PersonNotFoundException {
    var invalidPersonId = 1L;
    ...
    assertThrows(PersonNotFoundException.class,
            () -> personService.update(invalidPersonId,
                    updatePersonDTORequest));
  }
  
  @Test
  void testGivenValidPersonIdThenReturnSuccesOnDelete() throws
          PersonNotFoundException {
  ...
  @Test
  void testGivenInvalidPersonIdThenReturnSuccesOnDelete() throws
          PersonNotFoundException {
    var invalidPersonId = 1L;
